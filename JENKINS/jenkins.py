...
for i in res:
        ...
        subprocess.call(["cp", jenkins_workspace_dir+"JENKINS/install.py", jenkins_workspace_dir+"JENKINS/Readme.md", jenkins_workspace_dir+"JENKINS/crh.repo", service_dir])
